...
class FollowerViewModel : ViewModel() {
    private val listFollowerNonMutable = ArrayList<person>()
    private val listFollowerMutable = MutableLiveData<ArrayList<person>>()

    fun getListFollower(): LiveData<ArrayList<person>> {
