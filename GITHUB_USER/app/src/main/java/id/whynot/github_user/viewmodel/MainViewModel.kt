...
import id.whynot.github_user.MainActivity
...
class MainViewModel: ViewModel() {
    private val listUsersNonMutable = ArrayList<person>()
    private var listUsersMutable = MutableLiveData<ArrayList<person>>()

    fun getListUsers(): LiveData<ArrayList<person>> {
